...
LIGHT_TOKENS = {
    "menu_1_bg": "#065F46",              # verde escuro (emerald-800)
    "menu_1_bg_hover": "#047857",       # emerald-700
    "menu_1_text": "#FFFFFF",
    "menu_1_border": "#065F46",

    "menu_2_bg": "#059669",             # emerald-600
    "menu_2_bg_hover": "#047857",       # emerald-700
    "menu_2_text": "#FFFFFF",
    "menu_2_border": "#059669",

    "menu_3_bg": "#D1FAE5",             # emerald-100
    "menu_3_bg_hover": "#A7F3D0",       # emerald-200
    "menu_3_text": "#064E3B",           # emerald-900
    "menu_3_border": "#34D399",         # emerald-400

    "menu_inactive_text_on_dark": "#34D399",
    "menu_inactive_text_on_light": "#065F46",
    "menu_inactive_border_strong": "#34D399",
    "menu_inactive_border_soft": "#6EE7B7",
    "menu_inactive_hover_soft": "rgba(5,150,105,0.10)",

    "menu_shadow_soft": "0 0 0 1px rgba(5,150,105,0.10)",
    "menu_shadow_active": "0 1px 2px rgba(6,95,70,0.18)",

    "topo_text": "#111827",
    "titulo_destaque": "#10B981",       # emerald-500
...
DARK_TOKENS = {
    "menu_1_bg": "#047857",             # emerald-700
    "menu_1_bg_hover": "#059669",       # emerald-600
    "menu_1_text": "#FFFFFF",
    "menu_1_border": "#10B981",

    "menu_2_bg": "#059669",
    "menu_2_bg_hover": "#10B981",
    "menu_2_text": "#FFFFFF",
    "menu_2_border": "#34D399",

    "menu_3_bg": "#022C22",             # emerald-950 profundo
    "menu_3_bg_hover": "#064E3B",       # emerald-900
    "menu_3_text": "#ECFDF5",           # emerald-50
    "menu_3_border": "#10B981",

    "menu_inactive_text_on_dark": "#34D399",
    "menu_inactive_text_on_light": "#065F46",
    "menu_inactive_border_strong": "rgba(52,211,153,0.88)",
    "menu_inactive_border_soft": "rgba(52,211,153,0.72)",
    "menu_inactive_hover_soft": "rgba(16,185,129,0.16)",

    "menu_shadow_soft": "0 0 0 1px rgba(52,211,153,0.14)",
    "menu_shadow_active": "0 1px 3px rgba(0,0,0,0.35)",

    "topo_text": "#FFFFFF",
    "titulo_destaque": "#34D399",
    "content_header": "0.95rem",
    "subtitulo_bloco": "0.78rem",
    "progress_fill": "#10B981",
}
