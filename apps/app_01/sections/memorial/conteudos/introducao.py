...
def get_pagina() -> dict:
    return {
        ...
        "conteudos": [
            {
                "id": "contexto_definicao_problema",
                ...
                "blocos": [
                    ...
                    {
                        "tipo": "questao_texto",
                        "id": "m_intro_situacao_sistema_001",
                    ...
                    {
                        "tipo": "questao_texto",
                        "id": "m_intro_problema_identificado_001",
                    ...
                    {
                        "tipo": "questao_texto",
                        "id": "m_intro_recorte_analise_001",
                    ...
                    {
                        "tipo": "questao_texto",
                        "id": "m_intro_pergunta_tecnica_001",
                    ...
                    {
                        "tipo": "questao_texto",
                        "id": "m_intro_objetivo_trabalho_001",
