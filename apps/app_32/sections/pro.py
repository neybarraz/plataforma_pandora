...
from .pro_conteudo.simulador_ambiente_3d import render_simulador_ambiente_3d
from .pro_conteudo.simulador_ambiente_2d import render_simulador_ambiente_2d
from .pro_conteudo.simulador_conveccao_dinamica import render_simulador_conveccao
from .pro_conteudo.simulador_radiacao import render_simulador_radiacao

from .pro_conteudo.simulador_campo_termico_2d import render_gradiente_termico
...
#     with st.container(key="problema_topo_box"):
#         render_topo_html(
#             "problema-topo",
#             """
#             pro
...
def _render_questao_texto(
    ...
    with col_save:
        if st.button(
            "Salvar resposta",
            key=f"problema_save_text_{questao_id}",
            use_container_width=True,
        ):
...
def _render_bloco(
    ...
    if tipo == "simulador_ambiente_3d":
        render_simulador_ambiente_3d()
        return
    if tipo == "simulador_ambiente_2d":
        render_simulador_ambiente_2d()
        return
    if tipo == "simulador_campo_termico_2d":
        render_gradiente_termico()
        return
    if tipo == "simulador_conveccao":
        render_simulador_conveccao()
        return    
    if tipo == "simulador_radiacao":
        render_simulador_radiacao()
        return    
