...
def get_paginas() -> list[dict[str, Any]]:
    return [
        {"id": "pagina_1", "titulo_menu": "Hidrostática", "conteudos": [
            _build_conteudo("b3_1_01", "🌱 Dos conceitos às leis", b3_1_01),
            _build_conteudo("b3_1_02", "🔧 Desafio de engenharia", b3_1_02),
            _build_conteudo("b3_1_03", "✏️ Exercícios aplicados", b3_1_03),
        ],},
        # {"id": "pagina_2", "titulo_menu": "Hidrodinâmica", "conteudos": [
        #     _build_conteudo("entrega_2_01", "O que acontece com a carga no campo?", entrega_1_01),
        #     _build_conteudo("entrega_2_02", "Por que a trajetória muda?", entrega_1_02),
        #     _build_conteudo("entrega_2_03", "Como depende da velocidade?", entrega_1_03),
        #     _build_conteudo("entrega_2_04", "Qual o tipo de movimento?", entrega_1_04),
        # ],},
