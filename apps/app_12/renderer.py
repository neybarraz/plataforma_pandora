...
from .sections.problema.problema import render as render_problema
from .sections.investigacao.investigacao import render as render_investigacao
from .sections.solucao.solucao import render as render_solucao
from .sections.memorial.memorial import render as render_memorial
...
def render_section(
    ...
    if section == "memorial":
        render_memorial(username=username, saved_data=saved_data)
        return
